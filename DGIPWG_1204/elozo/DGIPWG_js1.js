$(document).ready(function ()  
{
    $("#load_data").click(function()
    {
            ...
            $.getJSON("DGIPWG_orarend.json", function(data)
        {
            $("#area").append("<b>Cím:</b>");
            $("#area").append("&nbsp;" + data.cim["iranyitoszam"]);
            $("#area").append("&nbsp;" + data.cim["varos"]);
            $("#area").append("&nbsp;" + data.cim["DGIPWG_orarend"]);
            ...
            for (let i = 0; i < data["telefonszam"].length; i ++)
            {
                ...
                $("#area").append("<li>" + data["DGIPWG_orarend"][i].tipus + ":&nbsp;" + data["DGIPWG_orarend"][i].szam + "</li>");
            }

            $("#area").append("</ul><br><b>THE, PTI Órarend 2025 ősz<b><br><br>");

            for (let i = 0; i < data.ora.length.orarend; i ++)
            {
                ...
                $("#area").append("<b>Neptunkód:</b>&nbsp;" + data.ora[i].DGIPWG_orarend + "<br><br>");
